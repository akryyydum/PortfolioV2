...
const PosterGallery = () => {
  ...
  return (
    <div className="p-4 sm:p-6">
            ...
            >
              {poster.src && !failedPosters.has(poster.id) ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 p-4">
                  <div
                    className="w-10 h-10 rounded-full border flex items-center justify-center opacity-40"
              ...
              >
                <span
                  className="text-xs font-medium text-white/90 leading-snug"
                ...
                <span
                  ...
                  style={{ color: poster.accent, fontFamily: "'DM Mono', monospace" }}
                >
                  {poster.category}
                </span>
              </div>
      ...
      <p
        className="mt-5 text-center text-[10px] text-white/20 tracking-widest uppercase"
        style={{ fontFamily: "'DM Mono', monospace" }}
      >
        hover to preview · {posterData.length} works
      </p>
    </div>
  );
};
...
function Projects() {
  ...
  const devContent = [
    {
      title: "TransparaBrgy: Blockchain-based Transparent Barangay Management System",
      description:
    ...
    {
      title: "National Book Store Replica: E-commerce Platform with Real-time Inventory Sync",
      description:
  ...
  return (
    <>
      <style>{`
        ...
        /* Poster grid: smaller cards on mobile */
        .poster-grid {
        ...
        @media (max-width: 768px) {
          .glass-scroll-wrapper { border-radius: 16px; }
          .projects-heading { font-size: 1.75rem; }
        }
      `}</style>

      <section
        className="relative flex flex-col justify-center items-center min-h-screen overflow-hidden bg-black/50"
        id="projects"
      >
        {/* ── Ambient orbs ── */}
        ...
        <div className="relative w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          <div className="mb-10 sm:mb-14 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <div className="text-xs text-white/30" style={{ fontFamily: "'DM Mono', monospace" }}>
                {activeTab === "dev"
                  ? `${String(devContent.length).padStart(2, "0")} dev entries`
          ...
          <div className="glass-scroll-wrapper">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.07] bg-white/[0.02] flex-wrap gap-y-2">
              ...
              {/* Right label */}
              <span
                className="ml-auto text-[10px] text-white/18 tracking-widest uppercase shrink-0 hidden sm:block"
                style={{ fontFamily: "'DM Mono', monospace" }}
              >
                portfolio.view
              </span>
